...
namespace NitroxServer.GameLogic
{
    public class TimeKeeper
    {
        ...
        public readonly static DateTime SUBNAUTICA_FUTURE_START_DATE = new DateTime(2287, 5, 7, 9, 36, 0);

        public readonly static float    SUBNAUTICA_BEGIN_TIME_OFFSET = 1200f / 86400f *
