...
namespace NitroxServer.ConsoleCommands
{
    internal class SayCommand : Command
    {
        ...
        public SayCommand(PlayerManager playerManager) : base("say", Perms.ADMIN, "<message>", "Even the lowliest of cogs needs to say something. SO SAY SOMETHING!", new[] {"broadcast"})
        {
